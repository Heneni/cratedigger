...
`)+`
`+u);const R=P+m+a,T=P+u+o,D=Oa(r,r.VERTEX_SHADER,R),C=Oa(r,r.FRAGMENT_SHADER,T);r.attachShader(E,D),r.attachShader(E,C),t.index0AttributeName!==void 0?r.bindAttribLocation(E,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(E,0,"position"),r.linkProgram(E);function w(y){if(i.debug.checkShaderErrors){const I=r.getProgramInfoLog(E)||"",F=r.getShaderInfoLog(D)||"",k=r.getShaderInfoLog(C)||"",K=I.trim(),Y=F.trim(),X=k.trim();let B=!0,j=!0;if(r.getProgramParameter(E,r.LINK_STATUS)===!1)if(B=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,E,D,C);else{const le=za(r,D,"vertex"),J=za(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(E,r.VALIDATE_STATUS)+`
...
}`;function Cd(i,e,t){let n=new Os;const r=new qe,s=new qe,a=new ot,o=new Zl({depthPacking:ul}),c=new $l,l={},h=t.maxTextureSize,f={[fn]:Mt,[Mt]:fn,[Qt]:Qt},p=new dn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qe},radius:{value:4}},vertexShader:wd,fragmentShader:Rd}),_=p.clone();_.defines.HORIZONTAL_PASS=1;const S=new pn;S.setAttribute("position",new Vt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new Ft(S,p),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ka;let u=this.type;this.render=function(C,w,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const d=i.getRenderTarget(),g=i.getActiveCubeFace(),y=i.getActiveMipmapLevel(),I=i.state;I.setBlending(un),I.buffers.depth.getReversed()?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const F=u!==Jt&&this.type===Jt,k=u===Jt&&this.type!==Jt;for(let K=0,Y=C.length;K<Y;K++){const X=C[K],B=X.shadow;if(B===void 0){console.warn("THREE.WebGLShadowMap:",X,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;r.copy(B.mapSize);const j=B.getFrameExtents();if(r.multiply(j),s.copy(B.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/j.x),r.x=s.x*j.x,B.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/j.y),r.y=s.y*j.y,B.mapSize.y=s.y)),B.map===null||F===!0||k===!0){const J=this.type!==Jt?{minFilter:Ot,magFilter:Ot}:{};B.map!==null&&B.map.dispose(),B.map=new Pn(r.x,r.y,J),B.map.texture.name=X.name+".shadowMap",B.camera.updateProjectionMatrix()}i.setRenderTarget(B.map),i.clear();const le=B.getViewportCount();for(let J=0;J<le;J++){const de=B.getViewport(J);a.set(s.x*de.x,s.y*de.y,s.x*de.z,s.y*de.w),I.viewport(a),B.updateMatrices(X,J),n=B.getFrustum(),T(w,x,B.camera,X,this.type)}B.isPointLightShadow!==!0&&this.type===Jt&&P(B,x),B.needsUpdate=!1}u=this.type,m.needsUpdate=!1,i.setRenderTarget(d,g,y)};function P(C,w){const x=e.update(E);p.defines.VSM_SAMPLES!==C.blurSamples&&(p.defines.VSM_SAMPLES=C.blurSamples,_.defines.VSM_SAMPLES=C.blurSamples,p.needsUpdate=!0,_.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Pn(r.x,r.y)),p.uniforms.shadow_pass.value=C.map.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,i.setRenderTarget(C.mapPass),i.clear(),i.renderBufferDirect(w,null,x,p,E,null),_.uniforms.shadow_pass.value=C.mapPass.texture,_.uniforms.resolution.value=C.mapSize,_.uniforms.radius.value=C.radius,i.setRenderTarget(C.map),i.clear(),i.renderBufferDirect(w,null,x,_,E,null)}function R(C,w,x,d){let g=null;const y=x.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(y!==void 0)g=y;else if(g=x.isPointLight===!0?c:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const I=g.uuid,F=w.uuid;let k=l[I];k===void 0&&(k={},l[I]=k);let K=k[F];K===void 0&&(K=g.clone(),k[F]=K,w.addEventListener("dispose",D)),g=K}if(g.visible=w.visible,g.wireframe=w.wireframe,d===Jt?g.side=w.shadowSide!==null?w.shadowSide:w.side:g.side=w.shadowSide!==null?w.shadowSide:f[w.side],g.alphaMap=w.alphaMap,g.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,g.map=w.map,g.clipShadows=w.clipShadows,g.clippingPlanes=w.clippingPlanes,g.clipIntersection=w.clipIntersection,g.displacementMap=w.displacementMap,g.displacementScale=w.displacementScale,g.displacementBias=w.displacementBias,g.wireframeLinewidth=w.wireframeLinewidth,g.linewidth=w.linewidth,x.isPointLight===!0&&g.isMeshDistanceMaterial===!0){const I=i.properties.get(g);I.light=x}return g}function T(C,w,x,d,g){if(C.visible===!1)return;if(C.layers.test(w.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&g===Jt)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,C.matrixWorld);const F=e.update(C),k=C.material;if(Array.isArray(k)){const K=F.groups;for(let Y=0,X=K.length;Y<X;Y++){const B=K[Y],j=k[B.materialIndex];if(j&&j.visible){const le=R(C,j,d,g);C.onBeforeShadow(i,C,w,x,F,le,B),i.renderBufferDirect(x,null,F,le,C,B),C.onAfterShadow(i,C,w,x,F,le,B)}}}else if(k.visible){const K=R(C,k,d,g);C.onBeforeShadow(i,C,w,x,F,K,null),i.renderBufferDirect(x,null,F,K,C,null),C.onAfterShadow(i,C,w,x,F,K,null)}}const I=C.children;for(let F=0,k=I.length;F<k;F++)T(I[F],w,x,d,g)}function D(C){C.target.removeEventListener("dispose",D);for(const x in l){const d=l[x],g=C.target.uuid;g in d&&(d[g].dispose(),delete d[g])}}}const Pd={[zr]:Hr,[kr]:Wr,[Vr]:Xr,[Zn]:Gr,[Hr]:zr,[Wr]:kr,[Xr]:Vr,[Gr]:Zn};function Dd(i,e){function t(){let L=!1;const re=new ot;let fe=null;const Te=new ot(0,0,0,0);return{setMask:function(ne){fe!==ne&&!L&&(i.colorMask(ne,ne,ne,ne),fe=ne)},setLocked:function(ne){L=ne},setClear:function(ne,$,we,He,tt){tt===!0&&(ne*=He,$*=He,we*=He),re.set(ne,$,we,He),Te.equals(re)===!1&&(i.clearColor(ne,$,we,He),Te.copy(re))},reset:function(){L=!1,fe=null,Te.set(-1,0,0,0)}}}function n(){let L=!1,re=!1,fe=null,Te=null,ne=null;return{setReversed:function($){if(re!==$){const we=e.get("EXT_clip_control");$?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),re=$;const He=ne;ne=null,this.setClear(He)}},getReversed:function(){return re},setTest:function($){$?Q(i.DEPTH_TEST):ae(i.DEPTH_TEST)},setMask:function($){fe!==$&&!L&&(i.depthMask($),fe=$)},setFunc:function($){if(re&&($=Pd[$]),Te!==$){switch($){case zr:i.depthFunc(i.NEVER);break;case Hr:i.depthFunc(i.ALWAYS);break;case kr:i.depthFunc(i.LESS);break;case Zn:i.depthFunc(i.LEQUAL);break;case Vr:i.depthFunc(i.EQUAL);break;case Gr:i.depthFunc(i.GEQUAL);break;case Wr:i.depthFunc(i.GREATER);break;case Xr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Te=$}},setLocked:function($){L=$},setClear:function($){ne!==$&&(re&&($=1-$),i.clearDepth($),ne=$)},reset:function(){L=!1,fe=null,Te=null,ne=null,re=!1}}}function r(){let L=!1,re=null,fe=null,Te=null,ne=null,$=null,we=null,He=null,tt=null;return{setTest:function($e){L||($e?Q(i.STENCIL_TEST):ae(i.STENCIL_TEST))},setMask:function($e){re!==$e&&!L&&(i.stencilMask($e),re=$e)},setFunc:function($e,qt,Bt){(fe!==$e||Te!==qt||ne!==Bt)&&(i.stencilFunc($e,qt,Bt),fe=$e,Te=qt,ne=Bt)},setOp:function($e,qt,Bt){($!==$e||we!==qt||He!==Bt)&&(i.stencilOp($e,qt,Bt),$=$e,we=qt,He=Bt)},setLocked:function($e){L=$e},setClear:function($e){tt!==$e&&(i.clearStencil($e),tt=$e)},reset:function(){L=!1,re=null,fe=null,Te=null,ne=null,$=null,we=null,He=null,tt=null}}}const s=new t,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let h={},f={},p=new WeakMap,_=[],S=null,E=!1,m=null,u=null,P=null,R=null,T=null,D=null,C=null,w=new Ze(0,0,0),x=0,d=!1,g=null,y=null,I=null,F=null,k=null;const K=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,X=0;const B=i.getParameter(i.VERSION);B.indexOf("WebGL")!==-1?(X=parseFloat(/^WebGL (\d)/.exec(B)[1]),Y=X>=1):B.indexOf("OpenGL ES")!==-1&&(X=parseFloat(/^OpenGL ES (\d)/.exec(B)[1]),Y=X>=2);let j=null,le={};const J=i.getParameter(i.SCISSOR_BOX),de=i.getParameter(i.VIEWPORT),he=new ot().fromArray(J),Be=new ot().fromArray(de);function G(L,re,fe,Te){const ne=new Uint8Array(4),$=i.createTexture();i.bindTexture(L,$),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let we=0;we<fe;we++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(re,0,i.RGBA,1,1,Te,0,i.RGBA,i.UNSIGNED_BYTE,ne):i.texImage2D(re+we,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ne);return $}const te={};te[i.TEXTURE_2D]=G(i.TEXTURE_2D,i.TEXTURE_2D,1),te[i.TEXTURE_CUBE_MAP]=G(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),te[i.TEXTURE_2D_ARRAY]=G(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),te[i.TEXTURE_3D]=G(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Q(i.DEPTH_TEST),a.setFunc(Zn),xe(!1),ve(qs),Q(i.CULL_FACE),Ue(un);function Q(L){h[L]!==!0&&(i.enable(L),h[L]=!0)}function ae(L){h[L]!==!1&&(i.disable(L),h[L]=!1)}function ce(L,re){return f[L]!==re?(i.bindFramebuffer(L,re),f[L]=re,L===i.DRAW_FRAMEBUFFER&&(f[i.FRAMEBUFFER]=re),L===i.FRAMEBUFFER&&(f[i.DRAW_FRAMEBUFFER]=re),!0):!1}function Se(L,re){let fe=_,Te=!1;if(L){fe=p.get(re),fe===void 0&&(fe=[],p.set(re,fe));const ne=L.textures;if(fe.length!==ne.length||fe[0]!==i.COLOR_ATTACHMENT0){for(let $=0,we=ne.length;$<we;$++)fe[$]=i.COLOR_ATTACHMENT0+$;fe.length=ne.length,Te=!0}}else fe[0]!==i.BACK&&(fe[0]=i.BACK,Te=!0);Te&&i.drawBuffers(fe)}function Re(L){return S!==L?(i.useProgram(L),S=L,!0):!1}const Pe={[An]:i.FUNC_ADD,[Fo]:i.FUNC_SUBTRACT,[Oo]:i.FUNC_REVERSE_SUBTRACT};Pe[Bo]=i.MIN,Pe[zo]=i.MAX;const b={[Ho]:i.ZERO,[ko]:i.ONE,[Vo]:i.SRC_COLOR,[Or]:i.SRC_ALPHA,[Ko]:i.SRC_ALPHA_SATURATE,[qo]:i.DST_COLOR,[Wo]:i.DST_ALPHA,[Go]:i.ONE_MINUS_SRC_COLOR,[Br]:i.ONE_MINUS_SRC_ALPHA,[Yo]:i.ONE_MINUS_DST_COLOR,[Xo]:i.ONE_MINUS_DST_ALPHA,[jo]:i.CONSTANT_COLOR,[Zo]:i.ONE_MINUS_CONSTANT_COLOR,[$o]:i.CONSTANT_ALPHA,[Jo]:i.ONE_MINUS_CONSTANT_ALPHA};function Ue(L,re,fe,Te,ne,$,we,He,tt,$e){if(L===un){E===!0&&(ae(i.BLEND),E=!1);return}if(E===!1&&(Q(i.BLEND),E=!0),L!==No){if(L!==m||$e!==d){if((u!==An||T!==An)&&(i.blendEquation(i.FUNC_ADD),u=An,T=An),$e)switch(L){case Yn:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ys:i.blendFunc(i.ONE,i.ONE);break;case Ks:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case js:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case Yn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ys:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Ks:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case js:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}P=null,R=null,D=null,C=null,w.set(0,0,0),x=0,m=L,d=$e}return}ne=ne||re,$=$||fe,we=we||Te,(re!==u||ne!==T)&&(i.blendEquationSeparate(Pe[re],Pe[ne]),u=re,T=ne),(fe!==P||Te!==R||$!==D||we!==C)&&(i.blendFuncSeparate(b[fe],b[Te],b[$],b[we]),P=fe,R=Te,D=$,C=we),(He.equals(w)===!1||tt!==x)&&(i.blendColor(He.r,He.g,He.b,tt),w.copy(He),x=tt),m=L,d=!1}function ue(L,re){L.side===Qt?ae(i.CULL_FACE):Q(i.CULL_FACE);let fe=L.side===Mt;re&&(fe=!fe),xe(fe),L.blending===Yn&&L.transparent===!1?Ue(un):Ue(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),s.setMask(L.colorWrite);const Te=L.stencilWrite;o.setTest(Te),Te&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),se(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?Q(i.SAMPLE_ALPHA_TO_COVERAGE):ae(i.SAMPLE_ALPHA_TO_COVERAGE)}function xe(L){g!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),g=L)}function ve(L){L!==Io?(Q(i.CULL_FACE),L!==y&&(L===qs?i.cullFace(i.BACK):L===Uo?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ae(i.CULL_FACE),y=L}function Le(L){L!==I&&(Y&&i.lineWidth(L),I=L)}function se(L,re,fe){L?(Q(i.POLYGON_OFFSET_FILL),(F!==re||k!==fe)&&(i.polygonOffset(re,fe),F=re,k=fe)):ae(i.POLYGON_OFFSET_FILL)}function Ce(L){L?Q(i.SCISSOR_TEST):ae(i.SCISSOR_TEST)}function nt(L){L===void 0&&(L=i.TEXTURE0+K-1),j!==L&&(i.activeTexture(L),j=L)}function Ye(L,re,fe){fe===void 0&&(j===null?fe=i.TEXTURE0+K-1:fe=j);let Te=le[fe];Te===void 0&&(Te={type:void 0,texture:void 0},le[fe]=Te),(Te.type!==L||Te.texture!==re)&&(j!==fe&&(i.activeTexture(fe),j=fe),i.bindTexture(L,re||te[L]),Te.type=L,Te.texture=re)}function A(){const L=le[j];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function v(){try{i.compressedTexImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function O(){try{i.compressedTexImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function W(){try{i.texSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Z(){try{i.texSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function q(){try{i.compressedTexSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function be(){try{i.compressedTexSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function oe(){try{i.texStorage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ee(){try{i.texStorage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Me(){try{i.texImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ee(){try{i.texImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function me(L){he.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),he.copy(L))}function Oe(L){Be.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),Be.copy(L))}function De(L,re){let fe=l.get(re);fe===void 0&&(fe=new WeakMap,l.set(re,fe));let Te=fe.get(L);Te===void 0&&(Te=i.getUniformBlockIndex(re,L.name),fe.set(L,Te))}function _e(L,re){const Te=l.get(re).get(L);c.get(re)!==Te&&(i.uniformBlockBinding(re,Te,L.__bindingPointIndex),c.set(re,Te))}function ke(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},j=null,le={},f={},p=new WeakMap,_=[],S=null,E=!1,m=null,u=null,P=null,R=null,T=null,D=null,C=null,w=new Ze(0,0,0),x=0,d=!1,g=null,y=null,I=null,F=null,k=null,he.set(0,0,i.canvas.width,i.canvas.height),Be.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:Q,disable:ae,bindFramebuffer:ce,drawBuffers:Se,useProgram:Re,setBlending:Ue,setMaterial:ue,setFlipSided:xe,setCullFace:ve,setLineWidth:Le,setPolygonOffset:se,setScissorTest:Ce,activeTexture:nt,bindTexture:Ye,unbindTexture:A,compressedTexImage2D:v,compressedTexImage3D:O,texImage2D:Me,texImage3D:ee,updateUBOMapping:De,uniformBlockBinding:_e,texStorage2D:oe,texStorage3D:Ee,texSubImage2D:W,texSubImage3D:Z,compressedTexSubImage2D:q,compressedTexSubImage3D:be,scissor:me,viewport:Oe,reset:ke}}function Ld(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new qe,h=new WeakMap;let f;const p=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(A,v){return _?new OffscreenCanvas(A,v):Qi("canvas")}function E(A,v,O){let W=1;const Z=Ye(A);if((Z.width>O||Z.height>O)&&(W=O/Math.max(Z.width,Z.height)),W<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const q=Math.floor(W*Z.width),be=Math.floor(W*Z.height);f===void 0&&(f=S(q,be));const oe=v?S(q,be):f;return oe.width=q,oe.height=be,oe.getContext("2d").drawImage(A,0,0,q,be),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+q+"x"+be+")."),oe}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),A;return A}function m(A){return A.generateMipmaps}function u(A){i.generateMipmap(A)}function P(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function R(A,v,O,W,Z=!1){if(A!==null){if(i[A]!==void 0)return i[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let q=v;if(v===i.RED&&(O===i.FLOAT&&(q=i.R32F),O===i.HALF_FLOAT&&(q=i.R16F),O===i.UNSIGNED_BYTE&&(q=i.R8)),v===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(q=i.R8UI),O===i.UNSIGNED_SHORT&&(q=i.R16UI),O===i.UNSIGNED_INT&&(q=i.R32UI),O===i.BYTE&&(q=i.R8I),O===i.SHORT&&(q=i.R16I),O===i.INT&&(q=i.R32I)),v===i.RG&&(O===i.FLOAT&&(q=i.RG32F),O===i.HALF_FLOAT&&(q=i.RG16F),O===i.UNSIGNED_BYTE&&(q=i.RG8)),v===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(q=i.RG8UI),O===i.UNSIGNED_SHORT&&(q=i.RG16UI),O===i.UNSIGNED_INT&&(q=i.RG32UI),O===i.BYTE&&(q=i.RG8I),O===i.SHORT&&(q=i.RG16I),O===i.INT&&(q=i.RG32I)),v===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(q=i.RGB8UI),O===i.UNSIGNED_SHORT&&(q=i.RGB16UI),O===i.UNSIGNED_INT&&(q=i.RGB32UI),O===i.BYTE&&(q=i.RGB8I),O===i.SHORT&&(q=i.RGB16I),O===i.INT&&(q=i.RGB32I)),v===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),O===i.UNSIGNED_INT&&(q=i.RGBA32UI),O===i.BYTE&&(q=i.RGBA8I),O===i.SHORT&&(q=i.RGBA16I),O===i.INT&&(q=i.RGBA32I)),v===i.RGB&&O===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),v===i.RGBA){const be=Z?$i:je.getTransfer(W);O===i.FLOAT&&(q=i.RGBA32F),O===i.HALF_FLOAT&&(q=i.RGBA16F),O===i.UNSIGNED_BYTE&&(q=be===Qe?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function T(A,v){let O;return A?v===null||v===Cn||v===fi?O=i.DEPTH24_STENCIL8:v===en?O=i.DEPTH32F_STENCIL8:v===hi&&(O=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Cn||v===fi?O=i.DEPTH_COMPONENT24:v===en?O=i.DEPTH_COMPONENT32F:v===hi&&(O=i.DEPTH_COMPONENT16),O}function D(A,v){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==Ot&&A.minFilter!==Ht?Math.log2(Math.max(v.width,v.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?v.mipmaps.length:1}function C(A){const v=A.target;v.removeEventListener("dispose",C),x(v),v.isVideoTexture&&h.delete(v)}function w(A){const v=A.target;v.removeEventListener("dispose",w),g(v)}function x(A){const v=n.get(A);if(v.__webglInit===void 0)return;const O=A.source,W=p.get(O);if(W){const Z=W[v.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&d(A),Object.keys(W).length===0&&p.delete(O)}n.remove(A)}function d(A){const v=n.get(A);i.deleteTexture(v.__webglTexture);const O=A.source,W=p.get(O);delete W[v.__cacheKey],a.memory.textures--}function g(A){const v=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(v.__webglFramebuffer[W]))for(let Z=0;Z<v.__webglFramebuffer[W].length;Z++)i.deleteFramebuffer(v.__webglFramebuffer[W][Z]);else i.deleteFramebuffer(v.__webglFramebuffer[W]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[W])}else{if(Array.isArray(v.__webglFramebuffer))for(let W=0;W<v.__webglFramebuffer.length;W++)i.deleteFramebuffer(v.__webglFramebuffer[W]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let W=0;W<v.__webglColorRenderbuffer.length;W++)v.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[W]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const O=A.textures;for(let W=0,Z=O.length;W<Z;W++){const q=n.get(O[W]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),a.memory.textures--),n.remove(O[W])}n.remove(A)}let y=0;function I(){y=0}function F(){const A=y;return A>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),y+=1,A}function k(A){const v=[];return v.push(A.wrapS),v.push(A.wrapT),v.push(A.wrapR||0),v.push(A.magFilter),v.push(A.minFilter),v.push(A.anisotropy),v.push(A.internalFormat),v.push(A.format),v.push(A.type),v.push(A.generateMipmaps),v.push(A.premultiplyAlpha),v.push(A.flipY),v.push(A.unpackAlignment),v.push(A.colorSpace),v.join()}function K(A,v){const O=n.get(A);if(A.isVideoTexture&&Ce(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&O.__version!==A.version){const W=A.image;if(W===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{te(O,A,v);return}}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+v)}function Y(A,v){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){te(O,A,v);return}t.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+v)}function X(A,v){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){te(O,A,v);return}t.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+v)}function B(A,v){const O=n.get(A);if(A.version>0&&O.__version!==A.version){Q(O,A,v);return}t.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+v)}const j={[Kr]:i.REPEAT,[wn]:i.CLAMP_TO_EDGE,[jr]:i.MIRRORED_REPEAT},le={[Ot]:i.NEAREST,[ll]:i.NEAREST_MIPMAP_NEAREST,[Ei]:i.NEAREST_MIPMAP_LINEAR,[Ht]:i.LINEAR,[sr]:i.LINEAR_MIPMAP_NEAREST,[Rn]:i.LINEAR_MIPMAP_LINEAR},J={[fl]:i.NEVER,[vl]:i.ALWAYS,[dl]:i.LESS,[ao]:i.LEQUAL,[pl]:i.EQUAL,[gl]:i.GEQUAL,[ml]:i.GREATER,[_l]:i.NOTEQUAL};function de(A,v){if(v.type===en&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===Ht||v.magFilter===sr||v.magFilter===Ei||v.magFilter===Rn||v.minFilter===Ht||v.minFilter===sr||v.minFilter===Ei||v.minFilter===Rn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,j[v.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,j[v.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,j[v.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,le[v.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,le[v.minFilter]),v.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,J[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Ot||v.minFilter!==Ei&&v.minFilter!==Rn||v.type===en&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");i.texParameterf(A,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function he(A,v){let O=!1;A.__webglInit===void 0&&(A.__webglInit=!0,v.addEventListener("dispose",C));const W=v.source;let Z=p.get(W);Z===void 0&&(Z={},p.set(W,Z));const q=k(v);if(q!==A.__cacheKey){Z[q]===void 0&&(Z[q]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,O=!0),Z[q].usedTimes++;const be=Z[A.__cacheKey];be!==void 0&&(Z[A.__cacheKey].usedTimes--,be.usedTimes===0&&d(v)),A.__cacheKey=q,A.__webglTexture=Z[q].texture}return O}function Be(A,v,O){return Math.floor(Math.floor(A/O)/v)}function G(A,v,O,W){const q=A.updateRanges;if(q.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,v.width,v.height,O,W,v.data);else{q.sort((ee,me)=>ee.start-me.start);let be=0;for(let ee=1;ee<q.length;ee++){const me=q[be],Oe=q[ee],De=me.start+me.count,_e=Be(Oe.start,v.width,4),ke=Be(me.start,v.width,4);Oe.start<=De+1&&_e===ke&&Be(Oe.start+Oe.count-1,v.width,4)===_e?me.count=Math.max(me.count,Oe.start+Oe.count-me.start):(++be,q[be]=Oe)}q.length=be+1;const oe=i.getParameter(i.UNPACK_ROW_LENGTH),Ee=i.getParameter(i.UNPACK_SKIP_PIXELS),Me=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,v.width);for(let ee=0,me=q.length;ee<me;ee++){const Oe=q[ee],De=Math.floor(Oe.start/4),_e=Math.ceil(Oe.count/4),ke=De%v.width,L=Math.floor(De/v.width),re=_e,fe=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,ke),i.pixelStorei(i.UNPACK_SKIP_ROWS,L),t.texSubImage2D(i.TEXTURE_2D,0,ke,L,re,fe,O,W,v.data)}A.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,oe),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ee),i.pixelStorei(i.UNPACK_SKIP_ROWS,Me)}}function te(A,v,O){let W=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(W=i.TEXTURE_3D);const Z=he(A,v),q=v.source;t.bindTexture(W,A.__webglTexture,i.TEXTURE0+O);const be=n.get(q);if(q.version!==be.__version||Z===!0){t.activeTexture(i.TEXTURE0+O);const oe=je.getPrimaries(je.workingColorSpace),Ee=v.colorSpace===cn?null:je.getPrimaries(v.colorSpace),Me=v.colorSpace===cn||oe===Ee?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Me);let ee=E(v.image,!1,r.maxTextureSize);ee=nt(v,ee);const me=s.convert(v.format,v.colorSpace),Oe=s.convert(v.type);let De=R(v.internalFormat,me,Oe,v.colorSpace,v.isVideoTexture);de(W,v);let _e;const ke=v.mipmaps,L=v.isVideoTexture!==!0,re=be.__version===void 0||Z===!0,fe=q.dataReady,Te=D(v,ee);if(v.isDepthTexture)De=T(v.format===pi,v.type),re&&(L?t.texStorage2D(i.TEXTURE_2D,1,De,ee.width,ee.height):t.texImage2D(i.TEXTURE_2D,0,De,ee.width,ee.height,0,me,Oe,null));else if(v.isDataTexture)if(ke.length>0){L&&re&&t.texStorage2D(i.TEXTURE_2D,Te,De,ke[0].width,ke[0].height);for(let ne=0,$=ke.length;ne<$;ne++)_e=ke[ne],L?fe&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,_e.width,_e.height,me,Oe,_e.data):t.texImage2D(i.TEXTURE_2D,ne,De,_e.width,_e.height,0,me,Oe,_e.data);v.generateMipmaps=!1}else L?(re&&t.texStorage2D(i.TEXTURE_2D,Te,De,ee.width,ee.height),fe&&G(v,ee,me,Oe)):t.texImage2D(i.TEXTURE_2D,0,De,ee.width,ee.height,0,me,Oe,ee.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){L&&re&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Te,De,ke[0].width,ke[0].height,ee.depth);for(let ne=0,$=ke.length;ne<$;ne++)if(_e=ke[ne],v.format!==Nt)if(me!==null)if(L){if(fe)if(v.layerUpdates.size>0){const we=Ea(_e.width,_e.height,v.format,v.type);for(const He of v.layerUpdates){const tt=_e.data.subarray(He*we/_e.data.BYTES_PER_ELEMENT,(He+1)*we/_e.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,He,_e.width,_e.height,1,me,tt)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,0,_e.width,_e.height,ee.depth,me,_e.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ne,De,_e.width,_e.height,ee.depth,0,_e.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?fe&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ne,0,0,0,_e.width,_e.height,ee.depth,me,Oe,_e.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ne,De,_e.width,_e.height,ee.depth,0,me,Oe,_e.data)}else{L&&re&&t.texStorage2D(i.TEXTURE_2D,Te,De,ke[0].width,ke[0].height);for(let ne=0,$=ke.length;ne<$;ne++)_e=ke[ne],v.format!==Nt?me!==null?L?fe&&t.compressedTexSubImage2D(i.TEXTURE_2D,ne,0,0,_e.width,_e.height,me,_e.data):t.compressedTexImage2D(i.TEXTURE_2D,ne,De,_e.width,_e.height,0,_e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?fe&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,_e.width,_e.height,me,Oe,_e.data):t.texImage2D(i.TEXTURE_2D,ne,De,_e.width,_e.height,0,me,Oe,_e.data)}else if(v.isDataArrayTexture)if(L){if(re&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Te,De,ee.width,ee.height,ee.depth),fe)if(v.layerUpdates.size>0){const ne=Ea(ee.width,ee.height,v.format,v.type);for(const $ of v.layerUpdates){const we=ee.data.subarray($*ne/ee.data.BYTES_PER_ELEMENT,($+1)*ne/ee.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,$,ee.width,ee.height,1,me,Oe,we)}v.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,me,Oe,ee.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,De,ee.width,ee.height,ee.depth,0,me,Oe,ee.data);else if(v.isData3DTexture)L?(re&&t.texStorage3D(i.TEXTURE_3D,Te,De,ee.width,ee.height,ee.depth),fe&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,me,Oe,ee.data)):t.texImage3D(i.TEXTURE_3D,0,De,ee.width,ee.height,ee.depth,0,me,Oe,ee.data);else if(v.isFramebufferTexture){if(re)if(L)t.texStorage2D(i.TEXTURE_2D,Te,De,ee.width,ee.height);else{let ne=ee.width,$=ee.height;for(let we=0;we<Te;we++)t.texImage2D(i.TEXTURE_2D,we,De,ne,$,0,me,Oe,null),ne>>=1,$>>=1}}else if(ke.length>0){if(L&&re){const ne=Ye(ke[0]);t.texStorage2D(i.TEXTURE_2D,Te,De,ne.width,ne.height)}for(let ne=0,$=ke.length;ne<$;ne++)_e=ke[ne],L?fe&&t.texSubImage2D(i.TEXTURE_2D,ne,0,0,me,Oe,_e):t.texImage2D(i.TEXTURE_2D,ne,De,me,Oe,_e);v.generateMipmaps=!1}else if(L){if(re){const ne=Ye(ee);t.texStorage2D(i.TEXTURE_2D,Te,De,ne.width,ne.height)}fe&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,me,Oe,ee)}else t.texImage2D(i.TEXTURE_2D,0,De,me,Oe,ee);m(v)&&u(W),be.__version=q.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function Q(A,v,O){if(v.image.length!==6)return;const W=he(A,v),Z=v.source;t.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+O);const q=n.get(Z);if(Z.version!==q.__version||W===!0){t.activeTexture(i.TEXTURE0+O);const be=je.getPrimaries(je.workingColorSpace),oe=v.colorSpace===cn?null:je.getPrimaries(v.colorSpace),Ee=v.colorSpace===cn||be===oe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const Me=v.isCompressedTexture||v.image[0].isCompressedTexture,ee=v.image[0]&&v.image[0].isDataTexture,me=[];for(let $=0;$<6;$++)!Me&&!ee?me[$]=E(v.image[$],!0,r.maxCubemapSize):me[$]=ee?v.image[$].image:v.image[$],me[$]=nt(v,me[$]);const Oe=me[0],De=s.convert(v.format,v.colorSpace),_e=s.convert(v.type),ke=R(v.internalFormat,De,_e,v.colorSpace),L=v.isVideoTexture!==!0,re=q.__version===void 0||W===!0,fe=Z.dataReady;let Te=D(v,Oe);de(i.TEXTURE_CUBE_MAP,v);let ne;if(Me){L&&re&&t.texStorage2D(i.TEXTURE_CUBE_MAP,Te,ke,Oe.width,Oe.height);for(let $=0;$<6;$++){ne=me[$].mipmaps;for(let we=0;we<ne.length;we++){const He=ne[we];v.format!==Nt?De!==null?L?fe&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,we,0,0,He.width,He.height,De,He.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,we,ke,He.width,He.height,0,He.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,we,0,0,He.width,He.height,De,_e,He.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,we,ke,He.width,He.height,0,De,_e,He.data)}}}else{if(ne=v.mipmaps,L&&re){ne.length>0&&Te++;const $=Ye(me[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,Te,ke,$.width,$.height)}for(let $=0;$<6;$++)if(ee){L?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,me[$].width,me[$].height,De,_e,me[$].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,ke,me[$].width,me[$].height,0,De,_e,me[$].data);for(let we=0;we<ne.length;we++){const tt=ne[we].image[$].image;L?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,we+1,0,0,tt.width,tt.height,De,_e,tt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,we+1,ke,tt.width,tt.height,0,De,_e,tt.data)}}else{L?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,De,_e,me[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,ke,De,_e,me[$]);for(let we=0;we<ne.length;we++){const He=ne[we];L?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,we+1,0,0,De,_e,He.image[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,we+1,ke,De,_e,He.image[$])}}}m(v)&&u(i.TEXTURE_CUBE_MAP),q.__version=Z.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function ae(A,v,O,W,Z,q){const be=s.convert(O.format,O.colorSpace),oe=s.convert(O.type),Ee=R(O.internalFormat,be,oe,O.colorSpace),Me=n.get(v),ee=n.get(O);if(ee.__renderTarget=v,!Me.__hasExternalTextures){const me=Math.max(1,v.width>>q),Oe=Math.max(1,v.height>>q);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,q,Ee,me,Oe,v.depth,0,be,oe,null):t.texImage2D(Z,q,Ee,me,Oe,0,be,oe,null)}t.bindFramebuffer(i.FRAMEBUFFER,A),se(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,Z,ee.__webglTexture,0,Le(v)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,Z,ee.__webglTexture,q),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ce(A,v,O){if(i.bindRenderbuffer(i.RENDERBUFFER,A),v.depthBuffer){const W=v.depthTexture,Z=W&&W.isDepthTexture?W.type:null,q=T(v.stencilBuffer,Z),be=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=Le(v);se(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,oe,q,v.width,v.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,oe,q,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,q,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,be,i.RENDERBUFFER,A)}else{const W=v.textures;for(let Z=0;Z<W.length;Z++){const q=W[Z],be=s.convert(q.format,q.colorSpace),oe=s.convert(q.type),Ee=R(q.internalFormat,be,oe,q.colorSpace),Me=Le(v);O&&se(v)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Me,Ee,v.width,v.height):se(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Me,Ee,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,Ee,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Se(A,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,A),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const W=n.get(v.depthTexture);W.__renderTarget=v,(!W.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),K(v.depthTexture,0);const Z=W.__webglTexture,q=Le(v);if(v.depthTexture.format===di)se(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0);else if(v.depthTexture.format===pi)se(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0,q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function Re(A){const v=n.get(A),O=A.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==A.depthTexture){const W=A.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),W){const Z=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,W.removeEventListener("dispose",Z)};W.addEventListener("dispose",Z),v.__depthDisposeCallback=Z}v.__boundDepthTexture=W}if(A.depthTexture&&!v.__autoAllocateDepthBuffer){if(O)throw new Error("target.depthTexture not supported in Cube render targets");const W=A.texture.mipmaps;W&&W.length>0?Se(v.__webglFramebuffer[0],A):Se(v.__webglFramebuffer,A)}else if(O){v.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[W]),v.__webglDepthbuffer[W]===void 0)v.__webglDepthbuffer[W]=i.createRenderbuffer(),ce(v.__webglDepthbuffer[W],A,!1);else{const Z=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=v.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,q)}}else{const W=A.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=i.createRenderbuffer(),ce(v.__webglDepthbuffer,A,!1);else{const Z=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=v.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,q)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Pe(A,v,O){const W=n.get(A);v!==void 0&&ae(W.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Re(A)}function b(A){const v=A.texture,O=n.get(A),W=n.get(v);A.addEventListener("dispose",w);const Z=A.textures,q=A.isWebGLCubeRenderTarget===!0,be=Z.length>1;if(be||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=v.version,a.memory.textures++),q){O.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(v.mipmaps&&v.mipmaps.length>0){O.__webglFramebuffer[oe]=[];for(let Ee=0;Ee<v.mipmaps.length;Ee++)O.__webglFramebuffer[oe][Ee]=i.createFramebuffer()}else O.__webglFramebuffer[oe]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){O.__webglFramebuffer=[];for(let oe=0;oe<v.mipmaps.length;oe++)O.__webglFramebuffer[oe]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(be)for(let oe=0,Ee=Z.length;oe<Ee;oe++){const Me=n.get(Z[oe]);Me.__webglTexture===void 0&&(Me.__webglTexture=i.createTexture(),a.memory.textures++)}if(A.samples>0&&se(A)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let oe=0;oe<Z.length;oe++){const Ee=Z[oe];O.__webglColorRenderbuffer[oe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[oe]);const Me=s.convert(Ee.format,Ee.colorSpace),ee=s.convert(Ee.type),me=R(Ee.internalFormat,Me,ee,Ee.colorSpace,A.isXRRenderTarget===!0),Oe=Le(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,Oe,me,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+oe,i.RENDERBUFFER,O.__webglColorRenderbuffer[oe])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),ce(O.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),de(i.TEXTURE_CUBE_MAP,v);for(let oe=0;oe<6;oe++)if(v.mipmaps&&v.mipmaps.length>0)for(let Ee=0;Ee<v.mipmaps.length;Ee++)ae(O.__webglFramebuffer[oe][Ee],A,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee);else ae(O.__webglFramebuffer[oe],A,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);m(v)&&u(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(be){for(let oe=0,Ee=Z.length;oe<Ee;oe++){const Me=Z[oe],ee=n.get(Me);let me=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(me=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(me,ee.__webglTexture),de(me,Me),ae(O.__webglFramebuffer,A,Me,i.COLOR_ATTACHMENT0+oe,me,0),m(Me)&&u(me)}t.unbindTexture()}else{let oe=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(oe=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(oe,W.__webglTexture),de(oe,v),v.mipmaps&&v.mipmaps.length>0)for(let Ee=0;Ee<v.mipmaps.length;Ee++)ae(O.__webglFramebuffer[Ee],A,v,i.COLOR_ATTACHMENT0,oe,Ee);else ae(O.__webglFramebuffer,A,v,i.COLOR_ATTACHMENT0,oe,0);m(v)&&u(oe),t.unbindTexture()}A.depthBuffer&&Re(A)}function Ue(A){const v=A.textures;for(let O=0,W=v.length;O<W;O++){const Z=v[O];if(m(Z)){const q=P(A),be=n.get(Z).__webglTexture;t.bindTexture(q,be),u(q),t.unbindTexture()}}}const ue=[],xe=[];function ve(A){if(A.samples>0){if(se(A)===!1){const v=A.textures,O=A.width,W=A.height;let Z=i.COLOR_BUFFER_BIT;const q=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,be=n.get(A),oe=v.length>1;if(oe)for(let Me=0;Me<v.length;Me++)t.bindFramebuffer(i.FRAMEBUFFER,be.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,be.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,be.__webglMultisampledFramebuffer);const Ee=A.texture.mipmaps;Ee&&Ee.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,be.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,be.__webglFramebuffer);for(let Me=0;Me<v.length;Me++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),oe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,be.__webglColorRenderbuffer[Me]);const ee=n.get(v[Me]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ee,0)}i.blitFramebuffer(0,0,O,W,0,0,O,W,Z,i.NEAREST),c===!0&&(ue.length=0,xe.length=0,ue.push(i.COLOR_ATTACHMENT0+Me),A.depthBuffer&&A.resolveDepthBuffer===!1&&(ue.push(q),xe.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,xe)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ue))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),oe)for(let Me=0;Me<v.length;Me++){t.bindFramebuffer(i.FRAMEBUFFER,be.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.RENDERBUFFER,be.__webglColorRenderbuffer[Me]);const ee=n.get(v[Me]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,be.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.TEXTURE_2D,ee,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,be.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&c){const v=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function Le(A){return Math.min(r.maxSamples,A.samples)}function se(A){const v=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Ce(A){const v=a.render.frame;h.get(A)!==v&&(h.set(A,v),A.update())}function nt(A,v){const O=A.colorSpace,W=A.format,Z=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||O!==Qn&&O!==cn&&(je.getTransfer(O)===Qe?(W!==Nt||Z!==Wt)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",O)),v}function Ye(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(l.width=A.naturalWidth||A.width,l.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(l.width=A.displayWidth,l.height=A.displayHeight):(l.width=A.width,l.height=A.height),l}this.allocateTextureUnit=F,this.resetTextureUnits=I,this.setTexture2D=K,this.setTexture2DArray=Y,this.setTexture3D=X,this.setTextureCube=B,this.rebindTextures=Pe,this.setupRenderTarget=b,this.updateRenderTargetMipmap=Ue,this.updateMultisampleRenderTarget=ve,this.setupDepthRenderbuffer=Re,this.setupFrameBufferTexture=ae,this.useMultisampledRTT=se}function Id(i,e){function t(n,r=cn){let s;const a=je.getTransfer(r);if(n===Wt)return i.UNSIGNED_BYTE;if(n===Rs)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Cs)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Qa)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===$a)return i.BYTE;if(n===Ja)return i.SHORT;if(n===hi)return i.UNSIGNED_SHORT;if(n===ws)return i.INT;if(n===Cn)return i.UNSIGNED_INT;if(n===en)return i.FLOAT;if(n===mi)return i.HALF_FLOAT;if(n===eo)return i.ALPHA;if(n===to)return i.RGB;if(n===Nt)return i.RGBA;if(n===di)return i.DEPTH_COMPONENT;if(n===pi)return i.DEPTH_STENCIL;if(n===no)return i.RED;if(n===Ps)return i.RED_INTEGER;if(n===io)return i.RG;if(n===Ds)return i.RG_INTEGER;if(n===Ls)return i.RGBA_INTEGER;if(n===Wi||n===Xi||n===qi||n===Yi)if(a===Qe)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Wi)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Xi)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===qi)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Yi)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Wi)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Xi)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===qi)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Yi)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Zr||n===$r||n===Jr||n===Qr)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Zr)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===$r)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Jr)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Qr)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===es||n===ts||n===ns)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===es||n===ts)return a===Qe?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===ns)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===is||n===rs||n===ss||n===as||n===os||n===ls||n===cs||n===us||n===hs||n===fs||n===ds||n===ps||n===ms||n===_s)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===is)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===rs)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ss)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===as)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===os)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ls)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===cs)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===us)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===hs)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===fs)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ds)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ps)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ms)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===_s)return a===Qe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ki||n===gs||n===vs)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Ki)return a===Qe?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===gs)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===vs)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ro||n===xs||n===Ms||n===Ss)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Ki)return s.COMPRESSED_RED_RGTC1_EXT;if(n===xs)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ms)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ss)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===fi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class bo extends St{constructor(e=null){super(),this.sourceTexture=e,this.isExternalTexture=!0}}const Ud=`
void main() {
