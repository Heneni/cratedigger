...
`)+`
`+u);const R=P+m+a,T=P+u+o,D=Oa(r,r.VERTEX_SHADER,R),C=Oa(r,r.FRAGMENT_SHADER,T);r.attachShader(E,D),r.attachShader(E,C),t.index0AttributeName!==void 0?r.bindAttribLocation(E,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(E,0,"position"),r.linkProgram(E);function w(y){if(i.debug.checkShaderErrors){const U=r.getProgramInfoLog(E)||"",F=r.getShaderInfoLog(D)||"",k=r.getShaderInfoLog(C)||"",K=U.trim(),Y=F.trim(),X=k.trim();let B=!0,$=!0;if(r.getProgramParameter(E,r.LINK_STATUS)===!1)if(B=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,E,D,C);else{const le=za(r,D,"vertex"),J=za(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(E,r.VALIDATE_STATUS)+`
